--[[
  Steal An Egg - Panel v18 (GitHub loader)
  Load this ONLY. Core is loaded by HttpGet when you press Auto or ESP.
  Fixes: late-biome egg detect + Oxide guard-hit regrab + PlantEgg bank.
]]
...
local CORE_URL = "https://raw.githubusercontent.com/kimpler1/scim/main/StealAnEgg_v18_Core.lua?cb=18"
...
hint.Text = "Approach | Escape  (v18 detect+deliver)"
...
statusLbl.Text = ("v18 egg-detect + guard-hit + plant.\nmount=%s"):format(tostring(howMount))
