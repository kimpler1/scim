...
local GLITCH_UI_VER = "V31"
local CORE_URL = "https://raw.githubusercontent.com/kimpler1/scim/main/Glitch_Core.lua?cb=v31"
...
fh.Text = "V31: Fast regrab; Walk Speed + Auto Farm + Fly retained."
fh.Parent = flyHint
