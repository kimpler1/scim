...
local GLITCH_UI_VER = "V30"
local CORE_URL = "https://raw.githubusercontent.com/kimpler1/scim/main/Glitch_Core.lua?cb=v30"
...
fh.Text = "V30: Walk Speed + Auto Farm + Fly (Best Version freeze)."
fh.Parent = flyHint
